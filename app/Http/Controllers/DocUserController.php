...
class DocUserController extends Controller
{
    ...
    public function index (Request $request)
    {
        ...
        if ($request)
        {
            ...
            return view ('Docente.Usuarios.index',["usuario"=>$usuario,"searchText"=>$query]);
    ...
    {
        $request->user()->authorizeRoles('docent');
        return view ("Docente.Usuarios.create");
    }
    ...
    public function store (UserFormRequest $request)
    {
        ...
        return Redirect::to('DocenteSCH/Usuarios');
    ...
    public function show (User $usuario)
    {
        ...
        return view("Docente.Usuarios.show",compact('usuario'));
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view("Docente.Usuarios.edit",["usuario"=>$usuario]);

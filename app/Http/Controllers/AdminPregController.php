...
class AdminPregController extends Controller
{
    /**
    ...
    public function store(PregFormRequest $request)
    {
        ...
        return redirect()->action('AdminTestController@verList', [$idT]);
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view("Administrador.Test.Pregunt.edit",["test"=>$test,"preg"=>$preg]);
    ...
    public function verList(Request $request,$id)
    {
        ...
        $resp=DB::table('respuestas as tbRe')
            ...
            ->get();
        return view ('Administrador.Test.Respuest.index',["valor"=>$valor,"resp"=>$resp,"test"=>$test,"preg"=>$preg]);
    }
}

...
class AlumnosController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->action('AlumnosController@verList', [$id]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action('AlumnosController@verList', [$idP]);
    }
    ...
    public function verList(Request $request,$id)
    {
        ...
        $P=DB::table('paralelos as tbU')
            ...
            ->get();
                ...
                ->get();
                return view ('Administrador.Alumnos.index',["valor"=>$valor,"user"=>$user,"parall"=>$parall,"nivel"=>$nivel,"anio"=>$anio]);
    ...
    public function AddEst(Request $request,$id)
    {
        ...
        $user=DB::table('users as tbU')
            ...
            ->get();
        $valor=$id;
        return view ('Administrador.Alumnos.edit',["valor"=>$valor,"user"=>$user,"parall"=>$parall,"nivel"=>$nivel,"anio"=>$anio]);

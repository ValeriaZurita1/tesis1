...
<div class="row">
    ...
    <h5><a href="{{asset('DocenteSCH/Test')}}">{{$test->desTest}}</a>>
            </h5>
		<h3>Pregunta: 
    ...
    @include('Docente.Test.Pregunt.modalR')
              ...
              <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{URL::action('DocPregController@verList',$usd->id)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-user-plus"></i>Respuesta Agg.</button></a>
                    <a href="{{URL::action('DocPregController@edit',$usd->id)}}"><button type="button" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Editar</button></a>
                ...
                {{-- @endif --}}
                @include('Docente.Test.Pregunt.modal')

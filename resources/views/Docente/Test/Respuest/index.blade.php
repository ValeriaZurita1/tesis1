...
<div class="row">
    ...
    <h5><a href="{{asset('DocenteSCH/Test')}}">{{$test->desTest}}</a>>
        <a href="{{URL::action('DocTestController@verList',$test->id)}}">{{$preg->desPreg}}</a>
            </h5>
		<h3>Respuesta:
    ...
    @include('Docente.Test.Respuest.modalR')
              ...
              <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{URL::action('DocRespController@edit',$usd->id)}}"><button type="button" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Editar</button></a>
                ...
                {{-- @endif --}}
                @include('Docente.Test.Respuest.modal')

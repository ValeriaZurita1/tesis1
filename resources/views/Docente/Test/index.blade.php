              ...
              <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{URL::action('DocTestController@verList',$usd->id)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-user-plus"></i>Preguntas Agg.</button></a>
                    <a href="{{URL::action('DocTestController@edit',$usd->id)}}"><button type="button" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Editar</button></a>

<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-registA-{{$vI}}">
{!!Form::open(array('url'=>'DocenteSCH/RegistroAsis','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
            {{Form::token()}}
                        @csrf
<div class="modal-dialog">
	...
	<div class="modal-body">
		...
		{{--  --}}
                        ...
                        {{--  --}}
                        <div class="form-group row">
                            <label for="idNi" class="col-md-4 col-form-label text-md-right">{{ __('Asistencia') }}</label>

                            <div class="col-md-6">

                                <input id="idNi" type="text" placeholder="0123456789" class="form-control{{ $errors->has('idNi') ? ' is-invalid' : '' }}" name="idAsis" value="{{$vI}}" readonly>
                            </div>
                        </div>
                        {{--  --}}
		{{--  --}}

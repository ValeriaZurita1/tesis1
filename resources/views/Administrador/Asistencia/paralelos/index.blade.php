    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h4>Reporte de Asistencias:
                <a href="{{ url('Admin/Reportes/Asistencia/curso/pdf') }}"><button type="button"
                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        @foreach ($paralelo->paraleloUsuario as $dataUsuario)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('UnidadSCH/Asistencia/paralelo/informe', $dataUsuario->id) }}"
                                        type="button" class="btn btn-primary"> Registro Asistencia </a>
                                </td>

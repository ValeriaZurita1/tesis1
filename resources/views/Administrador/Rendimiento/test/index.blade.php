...
<div class="row">
    ...
    <a href="{{URL::action('pdfRepAsisController@genListT',Auth::user()->id)}}"><button type="button" class="btn btn-outline-success"><i class="fa fa-user-plus"></i>Generar</button></a>

            ...
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-footer text-center">
                        <a href="{{ url('/UnidadSCH/actividades/info', 'Mama') }}" class="small-box-footer">Ver <i
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="panel">
                        ...
                        <div class="panel-footer text-center">
                            <a href="{{ url('/UnidadSCH/actividades/info', 'Papa') }}" class="small-box-footer">Ver <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="panel">
                        ...
                        <div class="panel-footer text-center">
                            <a href="{{ url('/UnidadSCH/actividades/info', 'Abuelo') }}" class="small-box-footer">Ver <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="panel">
                        ...
                        <div class="panel-footer text-center">
                            <a href="{{ url('/UnidadSCH/actividades/info', 'Hermano') }}" class="small-box-footer">Ver <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="panel">
                        ...
                        <div class="panel-footer text-center">
                            <a href="{{ url('/UnidadSCH/actividades/info', 'Primo') }}" class="small-box-footer">Ver <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>

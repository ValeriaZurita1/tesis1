...
<div class="container">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <img height="150" width="150" src="{{ asset('/img/fase1/vocalu/img1.jpg') }}" alt="">
                </div>
                <div class="col-lg-12 col-md-12">
                    <img height="150" width="150" src="{{ asset('/img/fase1/vocalu/img2.jpg') }}" alt="">
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <img height="150" width="150" src="{{ asset('/img/fase1/vocalu/img3.jpg') }}" alt="">
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 center">
            <a href="{{ url('/UnidadSCH/Vocales/U') }}" class="btn btn-primary btn-lg">Jugar <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
@stop

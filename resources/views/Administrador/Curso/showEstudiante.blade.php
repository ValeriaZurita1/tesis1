...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Paralelo :  {{$paralelo->nombreP}}
      <a href="{{ url('UnidadSCH/Curso/paralelo/estudiante/create',$paralelo->id)}}"><button type="button" class="btn btn-outline-success"><i class="fa fa-address-card" aria-hidden="true"></i> Añadir</button></a>
        </h3><br>

		<h3>Listado de estudiante : </h3><br>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <a href="" data-target="#modal-delete-{{$estudiante->id, $paralelo->id}}"  data-toggle="modal"><button type="button" class="btn btn-outline-danger btn-sm"><i class="fa fa-window-close-o"></i> Eliminar</button></a>
                ...
                {{-- @endif --}}
                   ...
                   @include('Administrador.Curso.modal4')

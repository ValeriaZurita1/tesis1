...
@section ('content')
	<div class="row">
		<div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
			<h3>Asignar Usuarios: {{$parall->nombreP}}</h3>
			@if (count($errors)>0)
...
<form method="POST" action="/UnidadSCH/Alumnos/{{$parall->id}}" enctype="multipart/form-data">
	@method('PUT')
	@csrf
	<div class="container">
                ...
                <div class="card-body">
                    <!-- <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}"> -->
                        ...
                        {{-- <div class="row">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <div class="col-lg-3 col-sm-3 col-md-3 colxs-12">
                            ...
                            <select name="idUser" class="form-control selectpicker" data-live-search="true">
                                @foreach ($user as $usd)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select name="idUser" class="form-control selectAltura2 selectpicker" data-live-search="true">
                                @foreach ($user as $usd)
                                <option value="{{$usd->id}}">{{$usd->name}} {{$usd->apellido}}</option>
                                @endforeach
                            </select>

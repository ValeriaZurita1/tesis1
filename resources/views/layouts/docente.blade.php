...
{{--                   <div class="pull-left">
                       <a href="{{URL::action('PerfilDController@edit',auth::user()->id)}}"><button type="button" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Editar</button></a>
                    </div> --}}
                  {{--  --}}
                  <div class="pull-right">
      ...
      {{-- <form action="{{asset('GestorMSA/BusquedaA')}}" method="get" class="sidebar-form"> --}}
        {{-- {!! Form::open(['url'=>'GestorDocente/BusquedaA', 'method'=>'GET', 'class'=>'sidebar-form', 'role'=>'buscarAdm']) !!}
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{asset('DocenteSCH/Usuarios')}}"><i class="fa fa-circle-o"></i> Usuarios</a></li>
                <li><a href="{{asset('DocenteSCH/Curso')}}"><i class="fa fa-circle-o"></i> Cursos</a></li>
                <li><a href="{{asset('DocenteSCH/Asistencia')}}"><i class="fa fa-circle-o"></i> Asistencia</a></li>
                <li><a href="{{asset('DocenteSCH/Test')}}"><i class="fa fa-circle-o"></i> Test</a></li>
              </ul>
            </li>
            ...
            {{-- <li class="treeview">
              ...
              <ul class="treeview-menu">
                {{-- <li><a href="{{asset('DocenteSCH/Reportes/lista')}}"><i class="fa fa-circle-o"></i> Listado</a></li>
                <li><a href="{{asset('DocenteSCH/Reportes/Actividades')}}"><i class="fa fa-circle-o"></i> Actividades</a></li>

<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1"
    id="modal-regist-{{ auth::user()->id }}">
    {!! Form::open(['url' => 'EstudianteSCH/Asistencia', 'method' => 'POST', 'autocomplete' => 'off', 'files' => 'true']) !!}
    {{ Form::token() }}
    @csrf
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="idNivel" type="text" placeholder="0123456789"
                            ...
                            value="{{ $paraleloUsuario->paralelo->nivel->nombreN }}" readonly>
                        <input type="hidden" name="idNivel2" value="{{ $paraleloUsuario->paralelo->nivel->id }}">
                    </div>
                </div>
                <!--nuevos dtos  -->
                <!--  -->
                ...
                <div class="form-group row">
                    <label for="fechaA"
                        class="col-md-4 col-form-label text-md-right">{{ __('Fecha Asistencia') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="nombreP" type="text"
                            placeholder="{{ auth::user()->name }} {{ auth::user()->apellido }}"
                            class="form-control{{ $errors->has('nombreP') ? ' is-invalid' : '' }}" name="nombreP"
                            value="" readonly>

...
@section('content')
    <div id='contentS' align='center' class="row">
        ...
        <div class="d-none">
            {!! Form::open(['route' => ['Index.Estudiante.store', 'A']]) !!}
            <div class="form-group">
                {{ Form::label('name', 'Vocal A') }}
                {{ Form::text('name', 'Vocal A', ['class' => 'form-control']) }}
            </div>
        ...
        <div align="center">
            <a href="{{ route('AIndex') }}" class="btn btn-warning">Vover a Jugar</a>

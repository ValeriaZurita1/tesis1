...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/vLetraI.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'I']]) !!}
    ...
    <div align="center">
        <a href="{{ route('IIndex') }}" class="btn btn-warning">Vover a Jugar</a>
    ...
    <div id="titulo">ROMPECABEZAS</div>
  	<div id='conf'>
			...
			<div class="btn-group">
			  ...
			  @include('Estudiante.Rompecabezas.vocales.i.modal')
			</div>
      		...
      		<div>
      			...
      			<a href="{{URL::action('EstRompController@verObjI',$c)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-edit"></i>Registrar Tiempo</button></a></p>
      			</div>
      		</div>
	</div>
</div> --}}

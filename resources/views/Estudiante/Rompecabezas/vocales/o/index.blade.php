...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/vLetrO.css')}}">
@section('content')
{{-- llenar --}}
...
<div id='contentS' align='center' class="row">
    ...
    <iframe src="{{ URL::to('/games/letrao/index.html') }}" width="100%" height="700" allowFullScreen="true"></iframe>


    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'O']]) !!}
    ...
    <div align="center">
        <a href="{{ route('OIndex') }}" class="btn btn-warning">Vover a Jugar</a>
    ...
    <div id="titulo">ROMPECABEZAS</div>
  	<div id='conf'>
			...
			<div class="btn-group">
			  ...
			  @include('Estudiante.Rompecabezas.vocales.o.modal')
			</div>
      		...
      		<div>
      			...
      			<a href="{{URL::action('EstRompController@verObjO',$c)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-edit"></i>Registrar Tiempo</button></a></p>
      			</div>
      		</div>
	</div>
</div> --}}

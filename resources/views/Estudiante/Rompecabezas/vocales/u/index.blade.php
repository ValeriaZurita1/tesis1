...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'U']]) !!}
    ...
    <div id="titulo">ROMPECABEZAS</div>
  	<div id='conf'>
			...
			<div class="btn-group">
			  ...
			  @include('Estudiante.Rompecabezas.vocales.u.modal')
			</div>
      		...
      		<div>
      			...
      			<a href="{{URL::action('EstRompController@verObjU',$c)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-edit"></i>Registrar Tiempo</button></a></p>
      			</div>
      		</div>
	</div>
</div> --}}

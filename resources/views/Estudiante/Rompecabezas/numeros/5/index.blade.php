...
<link rel="stylesheet" href="{{ asset('css/nuCinco.css') }}">
...
@section('content')
    ...
    <div id='contentS' align='center' class="row">
        ...
        <iframe src="{{ URL::to('/games/numeros/numero5/index.html') }}" width="100%" height="700"
            allowFullScreen="true"></iframe>


        <div class="d-none">
            {!! Form::open(['route' => ['Index.Estudiante.store', 'Numero5']]) !!}
            <div class="form-group">
                {{ Form::label('name', 'Número 5') }}
                {{ Form::text('name', 'Número 5', ['class' => 'form-control']) }}
            </div>
        ...
        <div align="center">
            <a href="{{ route('NCCIndex') }}" class="btn btn-warning">Vover a Jugar</a>

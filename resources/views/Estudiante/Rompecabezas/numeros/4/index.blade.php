...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/nuCuatr.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Numero4']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Número 4') }}
            {{ Form::text('name', 'Número 4', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('NCIndex') }}" class="btn btn-warning">Vover a Jugar</a>

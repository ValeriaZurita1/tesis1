...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="row">
                <img class="imagen" src="{{ asset('/img/resources/Numeros/tres.jpg') }}" alt="">
            </div>
            <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <img class="imagen" src="{{ asset('/img/resources/Numeros/Ejemplo3.jpg') }}" alt="">
            </div>
            <div class="row">
                <h4 class="title"> Número 3 Lenguaje de Señas </h4>
                <p>En matemáticas un número puede representar una cantidad métrica o más generalmente un elemento de un sistema numérico o un número ordinal que representará una posición dentro de un orden de una serie determinada.</p>
            </div>
        </div>
    ...
    <div class="row button">
        <div class="col-md-12 col-lg-12 col-xs-6 col-s-6 center">
            <a href="{{ url('EstudianteSCH/ControlActividad/numeros/3/video') }}"><button type="button"

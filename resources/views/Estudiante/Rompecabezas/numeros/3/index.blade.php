...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/nuTres.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <iframe src="{{ URL::to('/games/numeros/numero3/index.html') }}" width="100%" height="700" allowFullScreen="true"></iframe>


    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Numero3']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Número 3') }}
            {{ Form::text('name', 'Número 3', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('NTIndex') }}" class="btn btn-warning">Vover a Jugar</a>

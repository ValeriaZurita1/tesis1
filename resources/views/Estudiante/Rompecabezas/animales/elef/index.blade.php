...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/nElef.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Elefante']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Elefante') }}
            {{ Form::text('name', 'Elefante', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('ElefIndex') }}" class="btn btn-warning">Vover a Jugar</a>

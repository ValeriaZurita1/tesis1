...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/nVaca.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Vaca']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Vaca') }}
            {{ Form::text('name', 'Vaca', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('VacIndex') }}" class="btn btn-warning">Vover a Jugar</a>

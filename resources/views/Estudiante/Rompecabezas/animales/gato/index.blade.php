...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/nGato.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Gato']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Gato') }}
            {{ Form::text('name', 'Gato', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('GatIndex') }}" class="btn btn-warning">Vover a Jugar</a>

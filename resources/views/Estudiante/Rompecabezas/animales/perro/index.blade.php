...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Perro']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Perro') }}
            {{ Form::text('name', 'Perro', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('PerrIndex') }}" class="btn btn-warning">Vover a Jugar</a>

...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/rPapa.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <iframe src="{{ URL::to('/games/familia/papa/index.html') }}" width="100%" height="700" allowFullScreen="true"></iframe>

    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Papa']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Papá') }}
            {{ Form::text('name', 'Papá', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('PaIndex') }}" class="btn btn-warning">Vover a Jugar</a>

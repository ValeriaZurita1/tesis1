...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Mama']]) !!}
    ...
    <div id="titulo">ROMPECABEZAS</div>
  	<div id='conf'>
			...
			<div class="btn-group">
			  ...
			  @include('Estudiante.Rompecabezas.familia.mama.modal')
			</div>
            ...
            <a href="{{URL::action('EstRompController@verObjMa',$c)}}"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-edit"></i>Registrar Tiempo</button></a></p>
            </div>
      		</div>
	</div>
</div> --}}

...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/rAbuelo.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Abuelo']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Abuelo') }}
            {{ Form::text('name', 'Abuelo', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('AbuIndex') }}" class="btn btn-warning">Vover a Jugar</a>

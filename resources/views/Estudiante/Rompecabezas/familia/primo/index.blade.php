...
<link rel="stylesheet" href="{{asset('css/botones.css')}}">
	<link rel="stylesheet" href="{{asset('css/rPrim.css')}}">
...
<div id='contentS' align='center' class="row">
    ...
    <div class="d-none">
        {!! Form::open(['route' => ['Index.Estudiante.store', 'Primo']]) !!}
        <div class="form-group">
            {{ Form::label('name', 'Primo') }}
            {{ Form::text('name', 'Primo', ['class' => 'form-control']) }}
        </div>
    ...
    <div align="center">
        <a href="{{ route('PriIndex') }}" class="btn btn-warning">Vover a Jugar</a>

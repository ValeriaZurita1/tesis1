    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-6 cl-lg-12 center">
                <h1> Clase Familia Primo </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-6 center">
                <iframe width="600" height="400" src="https://www.youtube.com/embed/oS9n9HnPUFY"
        ...
        <div class="row button">
            <a class="center" href="{{ url('/EstudianteSCH/Fam/primo') }}"><button type="button"

  ...
  <div class="sidebar3">
    ...
    <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/actividades/vocales') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/actividades/numeros') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}<br>
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/actividades/familia') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/actividades/animales') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
    <!-- end .sidebar1 --></div>

  ...
  <div class="sidebar3">
    ...
    <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/Vocales/A') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/Vocales/E') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/Vocales/I') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}<br>
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/Vocales/O') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-white">
            ...
            <a href="{{ url('/EstudianteSCH/Vocales/U') }}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{--  --}}
    <!-- end .sidebar1 --></div>

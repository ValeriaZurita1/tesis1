...
@section('content')
    ...
    @section('tbanner', 'Iniciar Sesión')
        ...
        <!-- section -->
        <div class="section layout_padding padding_bottom-0 loginEstudiante">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="full">
                                <img  class="img-reponsive" src="{{ asset('main/images/desarrollo-infantil.png') }}" alt="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="full">
                                <img  class="img-reponsive" src="{{ asset('main/images/slide-bg-img-01.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" >
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="{{ route('login') }}"
                                                ...
                                                <center><img src="{{ asset('/main/images/children.png') }}"
